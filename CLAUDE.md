...
1. **Обещание (Service Clause).** Какое обещание инструмент даёт потребителю? Создать/обновить Service Clause. Обещание содержит: триггер, входы, выходы, время отклика, инвариант, режим отказа.
