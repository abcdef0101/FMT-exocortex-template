...
**СТРОГО НЕЛЬЗЯ:** Скрипты, код, промпты, launchd/systemd-конфиги, агенты. Это ТОЛЬКО база данных — входы и выходы агентов. Агенты живут в своих DS-*-agent/ репо или DS-synchronizer/.
