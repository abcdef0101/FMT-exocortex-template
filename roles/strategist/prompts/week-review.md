...
> **Триггер:** Автоматический — Пн 00:00 (полночь Вс→Пн, launchd / systemd timer).
...
1. Собери Content ideas, накопленные за неделю (из DS-strategy/drafts/draft-list.md, captures, Close-отчётов)
...
```markdown
| Пост | Тема | Канал | Дата |
|------|------|-------|------|
| [Название](ссылка) | Краткое описание | TG / Habr / LinkedIn | Пн |
```
