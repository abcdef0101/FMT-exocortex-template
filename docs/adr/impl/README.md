...
> Планы реализации ADR. Один файл = один ADR.
> Формат: Markdown. Версионируются в git. Живые документы.
> Подробнее: [ADR lifecycle guide](https://github.com/abcdef0101/DS-kb/blob/main/guides/adr-lifecycle.md)
