...
Рабочая директория: `<директория этого CLAUDE.md>` (не из sub-директорий). `<директория этого CLAUDE.md>/memory/` = симлинк на auto-memory.
...
## 10. Пользовательское расширение CLAUDE.md
