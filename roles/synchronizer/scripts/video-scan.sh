...
#
# Использование:
#   video-scan.sh --workspace-dir /path/to/workspace
#   video-scan.sh --workspace-dir /path/to/workspace --new
#   video-scan.sh --workspace-dir /path/to/workspace --stale
#   video-scan.sh --workspace-dir /path/to/workspace --dry-run
#
...
CONFIG_DIR="$WORKSPACE_DIR/memory"
